...
#         rtn_type = self._classify_rtn_type(frequency, duty_cycle, amplitude, num_transitions)
        
#         # Check if this meets RTN criteria
#         is_telegraph = self._validate_rtn_characteristics(
#             amplitude, frequency, num_transitions, fit_result['fit_quality']
#         )
...
#     def _classify_rtn_type(self, frequency, duty_cycle, amplitude, num_transitions):
#         """
#         Classify RTN type based on paper characterization:
#         - High frequency spike-like: frequent short excursions
#         - Low frequency square-wave: longer periods, ~50% duty cycle
#         """
#         high_freq_threshold = getattr(self.config, 'rtn_high_freq_threshold', 0.1)
#         square_wave_duty_tolerance = 0.2  # Within 20% of 50%
        
#         if frequency > high_freq_threshold:
#             return 'high_freq_spike'
#         elif abs(duty_cycle - 0.5) < square_wave_duty_tolerance:
#             return 'low_freq_square'
#         else:
#             return 'irregular'
    
#     def _validate_rtn_characteristics(self, amplitude, frequency, num_transitions, fit_quality):
#         """Validate that detected signal meets RTN criteria from paper."""
...
#         return amplitude_ok and frequency_ok and transitions_ok and fit_ok
